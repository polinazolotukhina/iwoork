...
function wp_bootstrap_page_nav() {
  // Display the WordPress menu if available
  wp_nav_menu( 
    array( 
      'menu' => 'page_nav', /* menu name */
      'menu_class' => 'nav navbar-nav',
      'theme_location' => 'page_nav', /* where in the theme it's assigned */
      'container' => 'false', /* container class */
      'fallback_cb' => 'wp_bootstrap_main_nav_fallback', /* menu fallback */
      'walker' => new Bootstrap_walker()
    )
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
        ...
        wp_register_style( 'fontawesome', get_stylesheet_directory_uri() . '/library/css/awesome/cs/font-awesome.min.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'fontawesome' );

         wp_register_style( 'animated', get_stylesheet_directory_uri() . '/library/css/animated.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'animated' );

        wp_register_style( 'stylebutton', get_stylesheet_directory_uri() . '/stylebutton.css', array(), '1.0', 'all' );
        wp_enqueue_style( 'stylebutton' );

         wp_register_style('style', get_stylesheet_directory_uri() . '/library/css/styles.css', array(), '1.1', 'all');
  ...
  function wp_bootstrap_theme_js(){
    ...
    wp_register_script( 'wpbs-js', 
     ...
     wp_register_script( 'parallax', 
      get_template_directory_uri() . '/library/parallax.js', 
      array('jquery'), 
      '1.2' );

        wp_register_script( 'waypoints', 
      get_template_directory_uri() . '/library/jquery.waypoints.js', 
      array('jquery'), 
      '1.2' );

         wp_register_script( 'scroll', "http://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.3/ScrollMagic.js", 
      array('jquery'), 
      '1.2' );

       wp_register_script( 'scrollmagic', "http://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.5/plugins/debug.addIndicators.min.js", 
      array('jquery'), 
      '1.2' );


       wp_register_script( 'TweenMax', 
      get_template_directory_uri() . '/library/TweenMax.min.js', 
      array('jquery'), 
      '1.2' );


       wp_register_script( 'animation', 
      get_template_directory_uri() . '/library/animation.gsap.js', 
      array('jquery'), 
      '1.2' );

         wp_register_script( 'debag', 
      get_template_directory_uri() . '/library debug.addIndicators.js', 
      array('jquery'), 
      '1.2' );
    ...
    wp_enqueue_script( 'parallax', 0);
    wp_enqueue_script( 'waypoints' );
    wp_enqueue_script( 'scroll' );
    wp_enqueue_script( 'scrollmagic');
    wp_enqueue_script( 'TweenMax');
     wp_enqueue_script( 'animation' );
     wp_enqueue_script( 'debag' );
